...
SECRET_KEY = 'django-insecure--el)6(wzld+u%h8bu!-(2m$$d_#pf*#+@37t%e68a=7u3jm506'
...
EMAIL_USE_TLS = True  # Use TLS encryption (True/False)
...
SERVER_EMAIL = 'admin@example.com'  # Email address for error messages sent by Django
